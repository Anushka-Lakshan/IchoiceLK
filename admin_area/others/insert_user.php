...
<i class="fa fa-dashboard" ></i> Dashboard / Insert Admin user
...
<i class="fa fa-money fa-fw" ></i> Insert Admin user
...
$insert_admin = "insert into admins (admin_name,admin_email,admin_pass,admin_image,admin_contact,admin_address,admin_job) values ('$admin_name','$admin_email','$admin_pass','$admin_image','$admin_contact','$admin_address','$admin_job')";
